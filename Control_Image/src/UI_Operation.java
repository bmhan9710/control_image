...
public class UI_Operation {
	...
	UI_Operation() {
		...
		JPanel menu001 = menu001_Open();
		JPanel menu002 = menu002_Open();
		...
		//frame.add(panel);
		frame.add(tabPanel, BorderLayout.WEST);
		frame.add(menu001, BorderLayout.CENTER);
	...
	public JPanel menu002_Open() {
		...
		// set up labels
		JLabel directoryLbl = new JLabel();
		directoryLbl.setText("Find Directory2");
		JLabel searchTxtLbl = new JLabel();
		searchTxtLbl.setText("Search Text2");
		JLabel resultLbl = new JLabel();
